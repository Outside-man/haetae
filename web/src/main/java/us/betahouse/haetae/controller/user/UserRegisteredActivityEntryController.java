 ...
 *
 * @author zjb
 * @version : UserRegisteredActivityEntryController.java 2019/7/8 23:18 zjb
 */
@RestController
@RequestMapping(value = "/userRegisteredActivityEntry")
public class UserRegisteredActivityEntryController {
    /**
     * 日志实体
     */
...
//                AssertUtil.assertStringNotBlank(request.getUserId(), RestResultCode.ILLEGAL_PARAMETERS.getCode(), "用户不能为空");
            ...
            public Result<ActivityEntryList> execute() {
                ...
                return RestResultUtil.buildSuccessResult(activityEntryService.registeredActivityEntryQuery(activityEntryQueryRequest, /*request.getUserId()*/"17910139"), "获取报名信息列表列表成功");
            }
        });
    }
}
